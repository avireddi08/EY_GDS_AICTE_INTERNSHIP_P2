      ...
      <main>
        ...
        <section className="auction-images">
          ...
          <div className="image-grid">
            <div className="image-item"><img src="src/images/i1.jpg" alt="Furniture" /></div>
            <div className="image-item"><img src="src/images/i2.jpg" alt="Wrist Watches" /></div>
            <div className="image-item"><img src="src/images/i3.jpg" alt="Paintings" /></div>
          </div>
        </section>
